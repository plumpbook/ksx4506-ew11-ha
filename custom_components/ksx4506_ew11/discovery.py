...
GENERIC_SENSOR_AUXILIARY_COMMANDS = {0x41, 0xC1}
...
REQUEST_COMMANDS_BY_DEVICE = {
    ...
    GAS_DEVICE_ID: {
        GAS_STATUS_REQUEST,
        GAS_CONTROL_REQUEST,
        GAS_PERIODIC_SCAN_REQUEST,
    },
    METER_DEVICE_ID: {METER_STATUS_REQUEST, METER_CHARACTERISTIC_REQUEST},
    ENTRANCE_PANEL_DEVICE_ID: {ENTRANCE_PANEL_STATUS_REQUEST},
    THERMOSTAT_DEVICE_ID: {
...
AUXILIARY_COMMANDS_BY_DEVICE = {
    GENERIC_SENSOR_DEVICE_ID: GENERIC_SENSOR_AUXILIARY_COMMANDS,
